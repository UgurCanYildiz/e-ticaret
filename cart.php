            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="Resimler/product-1.jpg" alt="" style="width: 50px;"> Ürün İsmi</td>
                            <td class="align-middle">150 TL</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="Resimler/product-2.jpg" alt="" style="width: 50px;">  Ürün İsmi</td>
                            <td class="align-middle">150 TL</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="Resimler/product-3.jpg" alt="" style="width: 50px;">  Ürün İsmi</td>
                            <td class="align-middle">150 TL</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="Resimler/product-4.jpg" alt="" style="width: 50px;">  Ürün İsmi</td>
                            <td class="align-middle">150 TL</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="Resimler/product-5.jpg" alt="" style="width: 50px;">  Ürün İsmi</td>
                            <td class="align-middle">150 TL</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">

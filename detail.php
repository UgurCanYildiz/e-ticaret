    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Ürün Detayı</span>
            </nav>
        </div>
    </div>
</div>
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="Resimler/gomlek.jpg" alt="Image" style="height: 40px;">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="Resimler/cat-1.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="Resimler/gomlek.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="Resimler/cat-1.jpg" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">150.00 TL</h3>
                    ...
                    <div class="d-flex mb-4">
                        <strong class="text-dark mr-3">Renk :</strong>
                        <form>
                            <div class="custom-control custom-radio custom-control-inline">
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        ...
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-2">Bilgi</a>
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-3">Görüntülenme (0)</a>
                    </div>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">1 "Ürün Adı" için inceleme</h4>
                                    <div class="media mb-4">
                                        <img src="Resimler/gomlek.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>Uğur Can Yıldız<small> - <i>01 Ocak 2045</i></small></h6>
                                ...
                                <div class="col-md-6">
                                    <h4 class="mb-4">Değerlendir</h4>
                                    <small>Your email address will not be published. Required fields are marked *</small>
                                    <div class="d-flex my-3">
                                        <p class="mb-0 mr-2">Ürün Puanı * :</p>
